            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <select id="kd_mapel" name="kd_mapel" class="custom-select">
                        <option value="1000" <?= $jadwal_pelajaran['kd_mapel'] == '1000' ? ' selected="selected"' : ''; ?>>Matematika
                        </option>
                        <option value="1001" <?= $jadwal_pelajaran['kd_mapel'] == '1001' ? ' selected="selected"' : ''; ?>>Biologi
                        </option>
                        <option value="1002" <?= $jadwal_pelajaran['kd_mapel'] == '1002' ? ' selected="selected"' : ''; ?>>Bahasa Inggris
                        </option>
                        <option value="1003" <?= $jadwal_pelajaran['kd_mapel'] == '1003' ? ' selected="selected"' : ''; ?>>Fisika
                        </option>
                        <option value="1004" <?= $jadwal_pelajaran['kd_mapel'] == '1004' ? ' selected="selected"' : ''; ?>>Bahasa
                            Indonesia</option>
                        <option value="1005" <?= $jadwal_pelajaran['kd_mapel'] == '1005' ? ' selected="selected"' : ''; ?>>Kimia</option>
                        <option value="1006" <?= $jadwal_pelajaran['kd_mapel'] == '1006' ? ' selected="selected"' : ''; ?>>Ekonomi
                        </option>
                        <option value="1007" <?= $jadwal_pelajaran['kd_mapel'] == '1007' ? ' selected="selected"' : ''; ?>>Sosiologi
                        </option>
                        <option value="1008" <?= $jadwal_pelajaran['kd_mapel'] == '1008' ? ' selected="selected"' : ''; ?>>Sejarah
                        </option>
                        <option value="1009" <?= $jadwal_pelajaran['kd_mapel'] == '1009' ? ' selected="selected"' : ''; ?>>Sastra Jepang
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <select id="nip" name="nip" class="custom-select">
                        <option value="1234567890112343" <?= $jadwal_pelajaran['nip'] == '1234567890112343' ? ' selected="selected"' : ''; ?>>Ria
                            Nadiatama</option>
                        <option value="1234567890112344" <?= $jadwal_pelajaran['nip'] == '1234567890112344' ? ' selected="selected"' : ''; ?>>
                            Muhammad Zain</option>
                        <option value="1963122419123452" <?= $jadwal_pelajaran['nip'] == '1963122419123452' ? ' selected="selected"' : ''; ?>>Dea
                            Aryananda</option>
                        <option value="1963122419890030" <?= $jadwal_pelajaran['nip'] == '1963122419890030' ? ' selected="selected"' : ''; ?>>Reynara
                            Ghavin</option>
                        <option value="1963122419899008" <?= $jadwal_pelajaran['nip'] == '1963122419899008' ? ' selected="selected"' : ''; ?>>Akaela
                            Karina</option>
                        <option value="1963122419899022" <?= $jadwal_pelajaran['nip'] == '1963122419899022' ? ' selected="selected"' : ''; ?>>
                            Muhammad Husain</option>
                        <option value="1963122419899065" <?= $jadwal_pelajaran['nip'] == '1963122419899065' ? ' selected="selected"' : ''; ?>>Ahmad
                            Hafidzi</option>
                        <option value="1963122419899999" <?= $jadwal_pelajaran['nip'] == '1963122419899999' ? ' selected="selected"' : ''; ?>>Edward
                            Bramhiers</option>
                        <option value="1983122419899111" <?= $jadwal_pelajaran['nip'] == '1983122419899111' ? ' selected="selected"' : ''; ?>>Aveera
                            Narudhana</option>
                        <option value="1993122419899990" <?= $jadwal_pelajaran['nip'] == '1993122419899990' ? ' selected="selected"' : ''; ?>>Arisha
                            Hanifa</option>
                    </select>
                </div>
            </div>
