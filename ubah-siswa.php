    ...
    <section class="container">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="nis" name="nis" placeholder="masukkan nis siswa" type="text" class="form-control" required="required" value="<?= $siswa["nis"]; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="nama" class="col-4 col-form-label">Nama</label>
                <div class="col-8">
                    <input id="nama" name="nama" placeholder="masukkan nama siswa" type="text" class="form-control" required="required" value="<?= $siswa["nama"]; ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="jns_kelamin" id="jns_kelamin_0" type="radio" class="custom-control-input" value="Laki-laki" required="required" <?php echo ($siswa['jns_kelamin'] == 'Laki-laki') ? 'checked' : '' ?>>
                        <label for="jns_kelamin_0" class="custom-control-label">Laki-laki</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="jns_kelamin" id="jns_kelamin_1" type="radio" class="custom-control-input" value="Perempuan" required="required" <?php echo ($siswa['jns_kelamin'] == 'Perempuan') ? 'checked' : '' ?>>
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <textarea id="alamat" name="alamat" cols="40" rows="3" class="form-control"><?php echo $siswa["alamat"]; ?></textarea>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <div class="offset-4 col-8">
                    ...
                    <a class="btn btn-danger" href="data-siswa.php" style="color: #fff; text-decoration:none; ">Cancel</a>
                </div>
            </div>
        </form>
    </section>
