    ...
    <section id="tambah-data-siswa" class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="nis" name="nis" placeholder="masukkan nis siswa" type="text" class="form-control" required="required">
                </div>
            </div>
            <div class="form-group row">
                <label for="nama" class="col-4 col-form-label">Nama</label>
                <div class="col-8">
                    <input id="nama" name="nama" placeholder="masukkan nama siswa" type="text" class="form-control" required="required">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <div class="offset-4 col-8">
                    ...
                    <button name="submit" type="submit" class="btn btn-danger"><a href="data-siswa.php" style="color: #fff; text-decoration:none; ">Cancel</a></button>
                </div>
            </div>
        </form>
    </section>
