...
<head>
    ...
    <title>Data Admin | SIM Sekolah</title>
                        ...
                        <?php foreach ($users as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td class="button-action">
                                    <a href="ubah-admin.php?id=<?= $row["id"]; ?>"><button type="button" class="btn btn-sm btn-warning">Edit</button></a>
                                    <a href="hapus-admin.php?id=<?= $row["id"]; ?>"><button type="button" class="btn btn-sm btn-danger">Delete</button></a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
